...
export const STUDIO = {
  ...
  body: [
    ...
    "Seul ne veut pas dire isolé : Pixelbrute est incubé au VentureLab, à Liège, qui accompagne les jeunes entrepreneurs. J'y trouve un cadre, des conseils juridiques et comptables, et des gens qui ont déjà vu passer la question.",
  ...
  facts: [
    ...
    { lbl: "Dossiers publiés", val: "Cinq, dont un produit SaaS" },
...
export const FAQS = [
  ...
  },
  {
    ...
    a: "Des PME de la province de Liège, des agences immobilières et des indépendants. Le point commun : une personne qui décide, et qui attend du site des demandes de clients plutôt qu'une vitrine. Jusqu'ici, de la distribution de pièces moto, de l'électricité, du nettoyage à domicile, un cabinet de massage et un produit SaaS. Le secteur importe moins que la présence d'un vrai métier derrière.",
  },
  {
