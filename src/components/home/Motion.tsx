 ...
 *
 * gsap, ScrollTrigger et Lenis pèsent ~135 ko à eux trois. Importés en haut de
 * fichier, ils entraient dans le bundle initial de *toutes* les pages publiques
 *, donc téléchargés et exécutés avant que la page soit interactive, pour du
 * mouvement dont rien n'a besoin avant le premier scroll. Ils sont chargés ici
 * dans l'effet : le navigateur affiche et hydrate d'abord, anime ensuite.
 */
export default function Motion() {
  useEffect(() => {
    ...
    // L'import est asynchrone : le démontage peut survenir avant sa résolution.
    // `cancelled` couvre ce cas, `dispose` le cas normal.
    let cancelled = false;
