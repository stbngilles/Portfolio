...
export const metadata: Metadata = {
  ...
  description:
    "Décrivez votre projet en deux minutes, ou appelez le +32 492 20 02 75. Réponse sous 24 h ouvrées par la personne qui dessinera et codera le site. Premier appel de 30 minutes sans engagement.",
    ...
    <>
      ...
      <main className="pb-cp">
        ...
        <p className="pb-cp-lede">
          ...
          temps ou des clients aujourd&apos;hui, je m&apos;occupe de traduire ça en un site. Quatre
          questions, deux minutes, et rien ici n&apos;est un engagement.
        </p>
