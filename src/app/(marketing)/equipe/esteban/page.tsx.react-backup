...
const SECTIONS = [
  {
    n: "01",
    t: "L'informatique, ma vocation",
    p: "Actuellement en études d'informatique et développement d'applications, je gère toute la partie technique de l'agence. De l'architecture à la mise en ligne, en passant par le SEO, c'est moi qui pose les fondations sous le capot.",
  },
  {
    n: "02",
    t: "Ma vision d'un bon site",
    p: "Pour moi, un bon site va bien au-delà de l'esthétique. C'est avant tout un site fiable, parfaitement référencé et surtout un outil qui convertit les visiteurs en clients. Mon objectif technique est toujours de construire une plateforme qui réponde exactement à vos attentes — pas un truc à la mode qui sera obsolète dans deux ans.",
  },
  {
    n: "03",
    t: "Ce qui me motive",
    p: "Dans la création de sites web, ce qui m'anime le plus, c'est de pouvoir aider mes clients à gagner en visibilité. J'aime l'idée que mon code leur permette de continuer à vivre de leurs activités grâce à l'investissement qu'ils ont placé dans un outil performant. Leurs succès deviennent aussi les miens.",
  },
];
  ...
  return (
    ...
    >
      <div className="wrap pt-[160px] pb-[120px] max-[720px]:pt-[120px] max-[720px]:pb-[80px]">
        ...
        <div className="member-head">
          ...
          >
            ...
            >
              Design & développement · Expert technique
            </div>
          </motion.div>
          ...
          <ul className="stack-grid">
            {STACK.map((s, i) => (
              <li key={i} className="stack-item">
                ...
                <span className="stack-item-label">{s}</span>
              </li>
            ))}
          </ul>
        </motion.section>
        ...
        <div className="member-footer">
          <Link href="/equipe/amandine" className="member-next">
            <div
      ...
      <style>{`
        ...
        .stack-item:hover { background: var(--color-ink); }
        .stack-item:hover .stack-item-label { color: var(--color-paper); }
        .stack-item:hover .mono { color: var(--color-accent) !important; }
        ...
        @media (max-width: 860px) {
          ...
          .stack-block { padding: 56px 0 40px; margin-top: 48px; }
          .stack-grid { grid-template-columns: 1fr; }
          .stack-item-label { font-size: 19px; }
